...
for(var i = 2002; i <= 2003; i++) { //for(var i = 2002; i < 2021; i++) {
  ...
  // Export the table to Google Drive
      ...
      var params = {
        ...
        description: 'LSTday_daily_mean_'+year,
        bucket: 'bnntraining-bucket',  //bucket name
        fileNamePrefix: 'input2/' + 'LSTday_daily_mean_'+year, // folder + file name
  ...
  // Export the table to Google Drive
      var params = {
        ...
        description: 'LSTnight_daily_mean_'+year,
        bucket: 'bnntraining-bucket',  //bucket name
        fileNamePrefix: 'input2/' + 'LSTnight_daily_mean_'+year, // folder + file name
        fileFormat: 'CSV'              // Specify the file format (e.g., CSV)
      };
